...
public class FindNotBlockedEditionById extends SpecificationUtil implements EditionSpecification {
    ...
    public FindNotBlockedEditionById(int id) {
        this.id = id;
    }
    ...
    public List<Edition> query() throws RepositoryException {
        ...
        try (ConnectionProxy connection = ConnectionPoolImpl.INSTANCE.getConnection()) {
            PreparedStatement statement = connection.prepareStatement(FIND_NOT_BLOCKED_EDITIONS_BY_ID);
