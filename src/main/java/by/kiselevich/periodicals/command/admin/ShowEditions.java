...
public class ShowEditions implements Command {
    ...
    public Page execute(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            Map<Edition, Map.Entry<EditionTheme, EditionType>> editionThemeTypeMap = EntityMapsFactory.getInstance()
                    .getEditionAndThemeAndTypeMap(editionList, editionThemeList, editionTypeList);
