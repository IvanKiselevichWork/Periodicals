...
public class UserValidatorTest extends Assert {
    ...
    public void testCheckUserCredentialsOnSignUpInvalidLogin() throws ValidatorException {
        User user = getUser();
        user.setLogin("");
    ...
    @Test(expected = ValidatorException.class)
    public void testCheckUserCredentialsOnSignUpInvalidPassword() throws ValidatorException {
        User user = getUser();
        user.setPassword("");
        userValidator.checkUserCredentialsOnSignUp(user);
    }
    ...
    @Test(expected = ValidatorException.class)
    public void testCheckUserCredentialsOnSignUpInvalidFullName() throws ValidatorException {
        User user = getUser();
        user.setFullName("");
        userValidator.checkUserCredentialsOnSignUp(user);
    }
    ...
    @Test(expected = ValidatorException.class)
    public void testCheckUserCredentialsOnSignUpInvalidEmail() throws ValidatorException {
        User user = getUser();
        user.setEmail("");
        userValidator.checkUserCredentialsOnSignUp(user);
    }
